...
public class Payment {
	...
	@JoinColumn(name = "user_id", referencedColumnName = "user_id") // user_id is primary key of User class and foreign
																	// key of Payment class
	private User user;
	@ManyToOne // Many to one relationship
	@JoinColumn(name = "cart_id", referencedColumnName = "cart_id") // cart_id is primary key of Cart class and foreign
																	// key of Payment class
	private Cart cart;
