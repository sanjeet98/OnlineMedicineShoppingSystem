...
public class CartItemController {
	...
	public SuccessMessageDTO addcartitem(@Valid @RequestBody CartItemDTO cartitemdto, BindingResult br)
			throws ValidateException, CartException, MedicineNotFoundException, UserNotFoundException {
		if (br.hasErrors())
	...
	public SuccessMessageDTO editcartitem(@PathVariable("cid") int cid, @PathVariable("qty") int qty)
			throws ValidateException, CartException, MedicineNotFoundException, CartItemException {
	...
	public SuccessMessageDTO deletecartitem(@PathVariable("cid") int cid)
			throws ValidateException, CartException, MedicineNotFoundException, CartItemException {
